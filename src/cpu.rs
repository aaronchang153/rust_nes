...
static DISPATCH_TABLE: [[[(fn(&mut Cpu6502, AddressMode) -> Result<(), String>, AddressMode); 8]; 8]; 3] = [
    // c = 0
    [          // b = 0                                       = 1                                       = 2                                       = 3                                       = 4                                       = 5                                       = 6                                       = 7
    /* a = 0*/ [ (Cpu6502::ex_brk, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_php, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_bpl, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_clc, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     1*/ [ (Cpu6502::ex_jsr, AddressMode::Implicit), (Cpu6502::ex_bit, AddressMode::Implicit), (Cpu6502::ex_plp, AddressMode::Implicit), (Cpu6502::ex_bit, AddressMode::Implicit), (Cpu6502::ex_bmi, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_sec, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     2*/ [ (Cpu6502::ex_rti, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_pha, AddressMode::Implicit), (Cpu6502::ex_jmp, AddressMode::Implicit), (Cpu6502::ex_bvc, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_cli, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     3*/ [ (Cpu6502::ex_rts, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_pla, AddressMode::Implicit), (Cpu6502::ex_jmp, AddressMode::Implicit), (Cpu6502::ex_bvs, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_sei, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     4*/ [ (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_sty, AddressMode::Implicit), (Cpu6502::ex_dey, AddressMode::Implicit), (Cpu6502::ex_sty, AddressMode::Implicit), (Cpu6502::ex_bcc, AddressMode::Implicit), (Cpu6502::ex_sty, AddressMode::Implicit), (Cpu6502::ex_tya, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     5*/ [ (Cpu6502::ex_ldy, AddressMode::Implicit), (Cpu6502::ex_ldy, AddressMode::Implicit), (Cpu6502::ex_tay, AddressMode::Implicit), (Cpu6502::ex_ldy, AddressMode::Implicit), (Cpu6502::ex_bcs, AddressMode::Implicit), (Cpu6502::ex_ldy, AddressMode::Implicit), (Cpu6502::ex_clv, AddressMode::Implicit), (Cpu6502::ex_ldy, AddressMode::Implicit) ],
    /*     6*/ [ (Cpu6502::ex_cpy, AddressMode::Implicit), (Cpu6502::ex_cpy, AddressMode::Implicit), (Cpu6502::ex_iny, AddressMode::Implicit), (Cpu6502::ex_cpy, AddressMode::Implicit), (Cpu6502::ex_bne, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_cld, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     7*/ [ (Cpu6502::ex_cpx, AddressMode::Implicit), (Cpu6502::ex_cpx, AddressMode::Implicit), (Cpu6502::ex_inx, AddressMode::Implicit), (Cpu6502::ex_cpx, AddressMode::Implicit), (Cpu6502::ex_beq, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_sed, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    ],
    ...
    /*     4*/ [ (Cpu6502::ex_sta, AddressMode::IndexedIndirect), (Cpu6502::ex_sta, AddressMode::ZeroPage), (Cpu6502::op_err, AddressMode::Immediate), (Cpu6502::ex_sta, AddressMode::Absolute), (Cpu6502::ex_sta, AddressMode::IndirectIndexed), (Cpu6502::ex_sta, AddressMode::ZeroPageX), (Cpu6502::ex_sta, AddressMode::AbsoluteY), (Cpu6502::ex_sta, AddressMode::AbsoluteX) ],
    ...
    // c = 2
    [          // b = 0                                        = 1                                       = 2                                          = 3                                       = 4                                       = 5                                        = 6                                       = 7
    /* a = 0*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_asl, AddressMode::ZeroPage), (Cpu6502::ex_asl, AddressMode::Accumulator), (Cpu6502::ex_asl, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_asl, AddressMode::ZeroPageX), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_asl, AddressMode::Implicit) ],
    /*     1*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_rol, AddressMode::ZeroPage), (Cpu6502::ex_rol, AddressMode::Accumulator), (Cpu6502::ex_rol, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_rol, AddressMode::ZeroPageX), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_rol, AddressMode::Implicit) ],
    /*     2*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_lsr, AddressMode::ZeroPage), (Cpu6502::ex_lsr, AddressMode::Accumulator), (Cpu6502::ex_lsr, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_lsr, AddressMode::ZeroPageX), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_lsr, AddressMode::Implicit) ],
    /*     3*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_ror, AddressMode::ZeroPage), (Cpu6502::ex_ror, AddressMode::Accumulator), (Cpu6502::ex_ror, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_ror, AddressMode::ZeroPageX), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_ror, AddressMode::Implicit) ],
    /*     4*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_stx, AddressMode::ZeroPage), (Cpu6502::ex_txa, AddressMode::Implicit),    (Cpu6502::ex_stx, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_stx, AddressMode::ZeroPageX), (Cpu6502::ex_txs, AddressMode::Implicit), (Cpu6502::op_err, AddressMode::Implicit) ],
    /*     5*/ [ (Cpu6502::ex_ldx, AddressMode::Immediate), (Cpu6502::ex_ldx, AddressMode::ZeroPage), (Cpu6502::ex_tax, AddressMode::Implicit),    (Cpu6502::ex_ldx, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_ldx, AddressMode::ZeroPageX), (Cpu6502::ex_tsx, AddressMode::Implicit), (Cpu6502::ex_ldx, AddressMode::Implicit) ],
    /*     6*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_dec, AddressMode::ZeroPage), (Cpu6502::ex_dex, AddressMode::Implicit),    (Cpu6502::ex_dec, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_dec, AddressMode::ZeroPageX), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_dec, AddressMode::Implicit) ],
    /*     7*/ [ (Cpu6502::op_err, AddressMode::Implicit),  (Cpu6502::ex_inc, AddressMode::ZeroPage), (Cpu6502::ex_nop, AddressMode::Implicit),    (Cpu6502::ex_inc, AddressMode::Absolute), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_inc, AddressMode::ZeroPageX), (Cpu6502::op_err, AddressMode::Implicit), (Cpu6502::ex_inc, AddressMode::Implicit) ],
    ],
];
